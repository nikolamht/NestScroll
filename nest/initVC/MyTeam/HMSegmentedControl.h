...
typedef NS_ENUM(NSInteger, HMSegmentedControlSegmentAlignment) {
    HMSegmentedControlSegmentAlignmentCenter,
    HMSegmentedControlSegmentAlignmentLeft
};
...
@property (nonatomic, assign) HMSegmentedControlSegmentAlignment alignment;
...
/**
 title之间的间隔
 */
@property (nonatomic, readwrite ,assign) CGFloat DynamicSpace;

/**
 segment首尾的间隔
 */
@property (nonatomic, readwrite ,assign) CGFloat DynamicHeaderTailer;
